    ...
    <article>
      ...
      <Foundations title="Where this comes from — bearer tokens and DPoP">
        <p>
          ...
          That&rsquo;s deliberate — it makes tokens trivial to pass around — but it means the token
        ...
        <p>
          ...
          proof. Standard OAuth machinery — auth51 applies it per action rather than per session.
        </p>
      </Foundations>

...
export const metadata: Metadata = {
  ...
  description:
    'The design principles that mitigate the threat model: checksum verification, PoP key binding, scope and step authorization, delegation and intent binding, input hygiene. Plus which threats each closes.',
}
...
export default function SecurityAnchors() {
  return (
    <article>
      ...
      <P>
        This is the foundation: proving the agent is who it claims and hasn&rsquo;t changed. The{' '}
        <strong>checksum-verification</strong> anchor recomputes the agent&rsquo;s fingerprint at runtime
        and compares it to the registered value. <strong>Client-library integrity</strong> makes
      ...
      <P>
        ...
        modification. It is necessary but never sufficient alone, so it&rsquo;s backed by the

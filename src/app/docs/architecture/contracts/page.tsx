  ...
  return (
    <article>
      ...
      <Lead>
        ...
        generated from the Authority&rsquo;s own schemas, so a consumer literally cannot drift from what
      ...
      <Callout>
        ...
        <code className="code-inline">openapi.json</code> is the only way the wire shape changes — so
        drift can&rsquo;t creep in by hand.
      </Callout>
      ...
      <Deep title="Who consumes it, and why it’s a component at all">
        ...
        <P className="!mb-0">
          ...
          every client. It&rsquo;s the same instinct as the <a href="/docs/architecture/checksum">checksum

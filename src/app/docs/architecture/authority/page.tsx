  ...
  return (
    <article>
      ...
      <Lead>
        ...
        the short-lived tokens that carry those decisions — but it never sits on the request path
        between an agent and a resource. In Zero-Trust terms it&rsquo;s the Policy Decision Point; every
      ...
      <P>
        ...
        run, their per-step scopes, dependencies, and approval gates. It also holds the signing keys
        and publishes their public halves as a JWKS for resource servers to verify against.
      </P>
      ...
      <Callout>
        ...
        fails — there&rsquo;s no self-declared identity for an impostor to assert.
      </Callout>
      ...
      <Deep title="Why “adaptive” IDP">
        ...
        <P className="!mb-0">
          It&rsquo;s a reference implementation deliberately kept light — the trust and verification logic
          matters more than scale here, and it&rsquo;s designed to be fronted by, or ported into, existing

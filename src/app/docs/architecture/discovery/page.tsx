...
export default function DiscoveryService() {
  return (
    <article>
      ...
      <Lead>
        Discovery is a separate service on purpose. When an agent runs that nobody registered, its
        observed identity has to go <em>somewhere</em> a human can review it — but the last place you
      ...
      <P>
        ...
        computed checksum — to discovery. That&rsquo;s all discovery holds: proposed identities awaiting
      ...
      <P>
        ...
        into the Authority — the one sanctioned path for content to cross into the trust root.
      </P>

      <Callout>
        The join key is a checksum both sides compute independently — not a shared copy of the
      ...
      <Deep title="Why a whole service for this">
        <P>
          ...
          simplicity is exactly the property you don&rsquo;t want: an agent&rsquo;s system prompt is often its
        ...
        <P className="!mb-0">
          Discovery is where visibility-without-trust lives. Approval — a deliberate human action — is

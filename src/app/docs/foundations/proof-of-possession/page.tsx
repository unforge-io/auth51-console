...
export default function ProofOfPossessionFoundations() {
  return (
    <article>
      ...
      <P>
        mTLS binds the token to a client TLS certificate. It is strong, but it operates
      ...
      <Deep title="How this looks inside an intent token">
        ...
        <P className="!mb-0">
          One exception: tokens handed to an MCP server carry no{' '}
          <code className="code-inline">cnf</code>, because the server rather than the agent makes the

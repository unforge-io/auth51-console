  ...
  return (
    <article>
      ...
      <P>
        ...
        <em>Policy Decision Point</em> (PDP), which evaluates each request against policy
        and decides, and one or more <em>Policy Enforcement Points</em> (PEPs), which
      ...
      <P>
        The client runtime is a PEP. Embedded in the agent process, it computes
        the identity proof and refuses to let a governed call leave without a valid token. It is the
        enforcement point closest to the action.
      </P>
      <P>
        The resource-server verifier is a second PEP. It cryptographically checks

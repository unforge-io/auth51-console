...
export const metadata: Metadata = {
  ...
  description:
    'Grants, access tokens, bearer semantics, JWT and JWK. The OAuth machinery auth51 keeps, and the point where it stops being enough for agents.',
}
  ...
  return (
    <article>
      ...
      <P>
        ...
        defines it as a token that &ldquo;any party in possession of&rdquo; it can use. That property makes
        tokens trivial to pass between services. It is also a liability, because the token{' '}
        <em>is</em> the credential, so a copy is a working key. That observation is the
        motivation for proof-of-possession, two pages on.
      </P>
      ...
      <P>
        ...
        and scope. A resource server verifies the signature and reads the claims, with no call back
        to the issuer required.
      </P>
      <P>
        ...
        backward compatibility is a property of JWT rather than something auth51 invents.
      </P>
      ...
      <P>
        ...
        is what proof-of-possession needs to name a key without carrying the whole thing.
      </P>

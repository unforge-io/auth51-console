...
export const metadata: Metadata = {
  ...
  description:
    'How a client, its agents, and their workflows enter the Authority. This one-time step, automatable from CI/CD, establishes the identities everything else checks against.',
}
  ...
  return (
    <article>
      ...
      <Lead>
        ...
        built to be automated: run from a deploy step or CI/CD, not clicked through by hand.
      </Lead>
      ...
      <Deep title="Why registration is a governance boundary">
        <P>
          ...
          registered was reviewed and approved. So an <em>un</em>registered agent doesn&rsquo;t just

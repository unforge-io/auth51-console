...
export default function MultiAgentFlow() {
  return (
    <article>
      ...
      <Lead>
        The hardest case, and the one auth51 was built for: a run that isn&rsquo;t one agent but several — a
        supervisor planning, workers executing, each calling tools. This flow puts the other three
      ...
      <Deep title="How the four flows compose">
        ...
        <P className="!mb-0">
          The guarantee that emerges — a derived token is always a subset of the one it came from — is{' '}
